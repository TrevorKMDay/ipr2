...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \node (vrrsbt1) [outcome, fill=red!30] {\total{} PCG};
        \node (vrrsbt2) [outcome, fill=blue!30, below of=vrrsbt1,
...
%        \draw [->] (p2gender) to [out=150, in=30] (p2bapq) ;
        ...
        % bapq effects
        \draw [arrow,thick] (p1bapq) -- node[anchor=south] {\bapqpcg} (vrrsbt1) ;
        \draw [arrow,thick] (p2bapq) -- node[anchor=north] {\bapqscg} (vrrsbt2) ;
